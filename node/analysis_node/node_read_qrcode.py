...
def image_process(image):
    ...
    retval, decoded_info, points, straight_qrcode = qrd.detectAndDecodeMulti(image)
    return retval, decoded_info, points, straight_qrcode

class Node(DpgNodeABC):
    _ver = '0.0.1'

    node_label = 'QR Code Reader'
    node_tag = 'QRCodeReader'
    ...
    def update(
        ...
        if frame is not None:
            retval, texts, points, straight_qrcode = image_process(frame)
            if retval:
