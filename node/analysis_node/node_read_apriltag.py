...
def image_process(image, at_detector):
...
class Node(DpgNodeABC):
    ...
    node_label = 'AprilTag Reader'
    node_tag = 'AprilTagReader'
    ...
    def update(
        ...
        if frame is not None:
            ...
            tags = image_process(frame, self._at_detector)
            for tag in tags:
                tag_id = tag.tag_id
                center = tag.center
                corners = tag.corners
